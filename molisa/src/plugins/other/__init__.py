...
from nonebot.adapters.onebot.v11 import GroupRecallNoticeEvent, Bot, Message, FriendRecallNoticeEvent, PokeNotifyEvent, \
...
#         print(msg)
#         tu = f"[CQ:image,file={msg}]"
#         await flashimg.finish(message=Message("不要发闪照，好东西就要分享。"))
