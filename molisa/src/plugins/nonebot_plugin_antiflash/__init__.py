...
anti_flash_on = on_command(cmd="开启反闪照", aliases={"启用反闪照"}, permission=SUPERUSER | GROUP_ADMIN| GROUP_OWNER,  block=True)
anti_flash_off = on_command(cmd="禁用反闪照", permission=SUPERUSER | GROUP_ADMIN | GROUP_OWNER,  block=True)
